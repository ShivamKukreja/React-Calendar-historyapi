...
export default class ReactDatePicker extends React.Component {
  ...
  render() {
    return (
      <div className="datePicker input-group col-sm-12" onClick={this.onClickDatePickerArea}>
      <div className='col-sm-12'><p  className="text-capitalize">Select Date from the calender</p></div>
        <input
